---
name: debt
description: Technical debt analysis — Ivy scans for debt indicators, prioritizes by severity and effort, and tracks trends across runs.
---
...
Spawn ONE agent named **Ivy** with these instructions:
...
## Notes
- Ivy never modifies source code — analysis only
...
- Run after Petra (/map) for best results — Ivy benefits from understanding the architecture first
