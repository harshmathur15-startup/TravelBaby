...
Evaluates code on 8 dimensions and generates remediation tasks when quality fails. Complements `/review` — review finds line-level bugs, quality-judge gives an overall score with fix tasks.
