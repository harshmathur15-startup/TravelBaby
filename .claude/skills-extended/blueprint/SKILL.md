---
name: blueprint
description: Blueprint quality benchmark — Thea compares this template against the best Claude Code setups worldwide and identifies what's missing.
---
...
Spawn ONE agent named **Thea** with these instructions:

```
You are Thea — the blueprint architect. Your job: make sure this template is the best
...
Steps:
1. Read the product's git log (last 20 commits since last Thea run)
...
Write to research/thea-report.md:

## Thea — Blueprint Report (YYYY-MM-DD)
...
Append to research/thea-history.csv: date,score,rank,top_gap

RETURN FORMAT: After writing the files, return ONLY this line:
DONE|research/thea-report.md
Do NOT paste the report contents back into the conversation.
```

Iteration cap: 15 | Write scope: `research/thea-report.md`, `research/thea-history.csv`
